...
const Post = () => {
  return (
    <main className="bg-black shadow-2xl pt-6 border-b border-b-zinc-400 h-full w-full md:w-2/3  px-2 md:px-8 relative">
      <div className="flex gap-3 relative items-center">
          ...
          <div className="size-12 flex items-center justify-center bg-white p-0.5 rounded-full bg-linear-to-tr from-yellow-400 via-pink-500 to-purple-600">
            <div className="relative h-10 w-10 rounded-full overflow-hidden">
              <Image
                src="https://plus.unsplash.com/premium_photo-1664536392896-cd1743f9c02c?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8ZmFjZXxlbnwwfHwwfHx8MA%3D%3D"
                alt="abc"
                fill
     ...
     <div className="flex items-center gap-2 text-sm p-0 m-0">
      ...
      <div className="flex items-center gap-2 text-sm p-0 m-0">
        ...
        <p className="text-xs text-zinc-200">life lately…❤️</p>
      </div>
    </main>
  );
};
