...
const LoginPage = () => {
  return (
    <div className="flex flex-col min-h-screen bg-black text-white font-sans">
      <main className="grow flex flex-col md:flex-row items-center justify-center px-4 py-8 md:py-0">
        ...
        <div className="w-full max-w-87 flex flex-col items-center">
          <div className="w-full bg-[#121212] md:bg-black border md:border-none border-[#262626] rounded-xl md:rounded-none p-8 flex flex-col items-center">
            ...
            <div className="flex items-center gap-2 mt-10 cursor-pointer hover:opacity-80 transition-opacity">
              <FaFacebook className="text-[#1877f2] size-5" />
              <span className="text-sm font-semibold">Log in with Facebook</span>
            </div>

            <button className="w-full border border-[#363636] hover:bg-white/5 transition-colors rounded-lg py-2 mt-6 text-sm font-semibold">
              Create new account
            </button>
          </div>
        </div>
